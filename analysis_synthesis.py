...
def analysis(input_file, wav, frame_length=400, frame_step=80, fft_length=1024):
...
wavfile.write(os.path.join('synthesized', file_name+'_'+str(epoch)+'_resyn.wav'), 16000, est_wav.astype(np.int16))
